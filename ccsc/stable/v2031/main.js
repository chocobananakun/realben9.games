	...
	Game.Init=function()
	{
		...
		*/
		...
		Game.bakeryNameRefresh=function()
		{
			...
			if (name.indexOf('saysopensesame',name.length-('saysopensesame').length)>0 && !Game.sesame) {Game.Notify("I patched that","no OpenSesame for you :)"+'</a>',[32,0]);} //Game.OpenSesame();
